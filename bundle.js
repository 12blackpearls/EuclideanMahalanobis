    ...
    //---END COUNT EUCLIDEAN DISTANCE---
        ...
        if(indexfirst==null && indexsecond==null) {
            ...
            //count Covariance Matrix
                ...
                var newArray = covmat.map(function(arr) {
                    return arr.slice();
                });
                ...
                for(var x = 0; x < len; x++) {
                  ...
                  for(var y = 0; y < len; y++) {
                    //copy[x][y] = covmat[x][y].slice;
                    console.log(newArray[x][y]);
                  }
                }
                console.log("ENDCOV");
                var a = new m.Matrix(newArray);
                var a_inv = a.inverse();
                for(var x = 0; x < len; x++) {
                  for(var y = 0; y < len; y++) {
                    console.log(a_inv[x][y]);
                  }
                }
                ...
                var matmnobis = [];
                matmnobis[0] = [];
                console.log("COUNT MNOBIS");
                for(var y = 0; y < dimension; y++) {
                  matmnobis[0][y] = +alldata[indexfirst-1][y+1] - +alldata[indexsecond-1][y+1];
                  console.log(matmnobis[0][y]);
                }

                var b = new m.Matrix(matmnobis);
                ...
                for(var x = 0; x < dimension; x++) {
                  mnobis[0][x] = 0; 
                  for(var y = 0; y < dimension; y++) {
                    tempo = +matmnobis[0][y] * +a_inv[y][x];
                    mnobis[0][x] = mnobis[0][x] + tempo;
                  }
                }
...
},{"./lib/matrix.js":4}],3:[function(require,module,exports){
/**
...
},{"./inverse.js":3,"underscore":5}],5:[function(require,module,exports){
//     Underscore.js 1.8.3
